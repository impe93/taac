import { type ReactElement, type FC, useState, useCallback, useEffect, useMemo } from 'react'
...
/**
 * Editor di una singola nota. Estratto dalla vecchia rotta `NoteView` per poter
 * montare più pane contemporaneamente (una per scheda aperta) mantenendoli vivi.
 * Ogni pane possiede il proprio stato locale (title/content), autosave e toggle
 * editor: cambiando scheda i pane non attivi restano montati (nascosti dal
 * contenitore) preservando scroll e cursore.
 */
export const NotePane: FC<NotePaneProps> = ({ noteId }): ReactElement => {
